...
// node_modules/sanity/lib/_chunks/index-989e9e04.esm.js
...
function PaneRouterProvider(props) {
  ...
  const ctx = (0, import_react50.useMemo)(() => ({
    ...
    setView: (viewId) => {
      const restParams = (0, import_lodash.omit)(params, "view");
...
async function resolveIntent(options) {
  ...
  const fallbackEditorPanes = [[{
    ...
    params: _objectSpread(_objectSpread({}, (0, import_lodash.omit)(options.params, ["id"])), {}, {
...
function createResolvedPaneNodeStream(_ref6) {
  ...
  const resolvedPanes$ = routerPanesStream.pipe(map((rawRouterPanes) => [[{
    ...
    for (let i = 0; i < curr.length; i++) {
      ...
      if (!(0, import_lodash.isEqual)(prevValue, currValue)) {
        return {
...
var paneMap = {
  component: (0, import_react50.lazy)(() => import("./index-cf340a7d.esm-CFWJ3K3B.js")),
  document: (0, import_react50.lazy)(() => import("./index-cf8d3806.esm-33KXKUEX.js")),
  documentList: (0, import_react50.lazy)(() => import("./index-312d4f55.esm-XY6JS3MF.js")),
  list: (0, import_react50.lazy)(() => import("./index-5d6f54b8.esm-JPXLYDBA.js"))
};
var DeskToolPane = (0, import_react50.memo)(function DeskToolPane2(props) {
  ...
  if (!(0, import_lodash.isEqual)(prevParams, nextParams))
    return false;
  if (!(0, import_lodash.isEqual)(prevPayload, nextPayload))
    return false;
...
var DocumentPaneProvider = (0, import_react50.memo)((props) => {
  ...
  const toggleInspect = (0, import_react50.useCallback)(function() {
    ...
    if (toggle) {
      ...
      paneRouter.setParams((0, import_lodash.omit)(params, "inspect"));
    }
...
function TimelineMenu(_ref21) {
  ...
  const revLabel = chunk ? "".concat((0, import_lodash.upperFirst)(formatTimelineEventLabel(chunk.type)), " ").concat(timeAgo) : "Current version";
...
var isMenuButton = (0, import_lodash.negate)(isActionButton);
...
//# sourceMappingURL=chunk-53WI3ZKV.js.map
