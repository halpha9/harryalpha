...
// node_modules/sanity/lib/_chunks/desk-51d2f822.esm.js
...
function PaneItemPreview(props) {
  ...
  const title = isRecord$2(value.title) && (0, import_react.isValidElement)(value.title) || (0, import_lodash.isString)(value.title) || (0, import_lodash.isNumber)(value.title) ? value.title : null;
  const {
    draft,
    published,
    isLoading
                  ...
                  return (0, import_jsx_runtime.jsxs)("tr", {
                    children: [(0, import_jsx_runtime.jsx)("td", {
                      ...
                      children: (0, import_jsx_runtime.jsxs)(DocumentIdFlex, {
                        ...
                        }), documentId && (0, import_jsx_runtime.jsx)(import_react_copy_to_clipboard.CopyToClipboard, {
                          text: documentId,
                          onCopy: () => {
                            toast.push({
...
var PaneHeaderActions = (0, import_react.memo)((_ref19) => {
  ...
  const [actionMenuItems, contextMenuItems] = (0, import_react.useMemo)(() => {
    ...
    return (0, import_lodash.partition)(nonCreateMenuItem, (item) => item.showAsAction);
  }, [menuItems]);
  ...
  const combinedInitialValueTemplates = (0, import_react.useMemo)(() => {
    return (0, import_lodash.uniqBy)([...initialValueTemplateItemFromMenuItems, ...initialValueTemplateItemsFromStructure], (item) => hashObject([item.initialDocumentId, item.templateId, item.parameters]));
...
function parsePanesSegment(str) {
  ...
  return str.split(";").map((group) => {
    ...
    return [firstSibling, ...restOfSiblings.map((sibling) => _objectSpread(_objectSpread(_objectSpread({}, firstSibling), sibling), {}, {
      ...
      params: _objectSpread(_objectSpread({}, (0, import_lodash.omit)(firstSibling.params, exclusiveParams)), sibling.params),
...
var deskTool = definePlugin((options) => ({
  ...
  tools: [{
    ...
    component: (0, import_react.lazy)(() => import("./index-989e9e04.esm-YWNMHJHQ.js").then(function(n) {
      return n.i;
    })),
...
var ComponentBuilder = class {
  ...
  title(title) {
    return this.clone({
      title,
      id: this.spec.id || (0, import_lodash.camelCase)(title)
    });
  }
  getTitle() {
    return this.spec.title;
...
var GenericViewBuilder = class {
  ...
  title(title) {
    return this.clone({
      title,
      id: this.spec.id || (0, import_lodash.kebabCase)(title)
    });
  }
  getTitle() {
    return this.spec.title;
...
var DocumentBuilder = class {
  ...
  serialize() {
    ...
    const dupes = (0, import_lodash.uniq)(viewIds.filter((viewId, i) => viewIds.includes(viewId, i + 1)));
    if (dupes.length > 0) {
...
function menuItemsFromInitialValueTemplateItems(context, templateItems) {
  ...
  return templateItems.map((item) => {
    ...
    const params = (0, import_lodash.pickBy)({
...
var ListBuilder = class extends GenericListBuilder {
  ...
  serialize() {
    ...
    const dupes = serializedItems.filter((val, i) => (0, import_lodash.find)(serializedItems, {
      id: val.id
    }, i + 1));
    if (dupes.length > 0) {
...
function getDocumentTypeListItem(context, typeName) {
  ...
  const title = type.title || (0, import_lodash.startCase)(typeName);
...
function createStructureBuilder(_ref33) {
  ...
  const structureBuilder = {
    ...
    divider: () => ({
      id: (0, import_lodash.uniqueId)("__divider__"),
      type: "divider"
    }),
    view: views,
    context
...
//# sourceMappingURL=chunk-SVNGFYML.js.map
