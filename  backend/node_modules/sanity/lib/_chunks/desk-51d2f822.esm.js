...
import { isString, isNumber, partition, uniqBy, omit, camelCase, kebabCase, uniq, pickBy, find, startCase, uniqueId } from 'lodash';
...
const deskTool = definePlugin(options => ({
  ...
  tools: [{
    ...
    component: lazy(() => import('./index-989e9e04.esm.js').then(function (n) {
      return n.i;
    })),
...
//# sourceMappingURL=desk-51d2f822.esm.js.map
