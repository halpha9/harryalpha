...
import { noop as noop$1, isEqual, isPlainObject, groupBy, sortBy, size } from 'lodash';
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-69adc238.esm.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
//# sourceMappingURL=_internal-620f784e.esm.js.map
