                  ...
                  return /* @__PURE__ */jsxRuntime.jsxs("tr", {
                    children: [/* @__PURE__ */jsxRuntime.jsx("td", {
                      ...
                      children: /* @__PURE__ */jsxRuntime.jsxs(DocumentIdFlex, {
                        ...
                        }), documentId && /* @__PURE__ */jsxRuntime.jsx(reactCopyToClipboard.CopyToClipboard, {
                          text: documentId,
                          onCopy: () => {
                            toast.push({
...
const PaneHeaderActions = React.memo(_ref19 => {
  ...
  const [actionMenuItems, contextMenuItems] = React.useMemo(() => {
    ...
    return lodash.partition(nonCreateMenuItem, item => item.showAsAction);
  }, [menuItems]);
  ...
  const combinedInitialValueTemplates = React.useMemo(() => {
    return lodash.uniqBy([...initialValueTemplateItemFromMenuItems, ...initialValueTemplateItemsFromStructure], item => hashObject([item.initialDocumentId, item.templateId, item.parameters]));
...
const deskTool = sanity.definePlugin(options => ({
  ...
  tools: [{
    ...
    component: React.lazy(() => Promise.resolve().then(function () {
      return require('./index-7ca32889.js');
    }).then(function (n) {
      return n.index;
    })),
...
class GenericViewBuilder {
  ...
  title(title) {
    return this.clone({
      title,
      id: this.spec.id || lodash.kebabCase(title)
    });
  }
  getTitle() {
    return this.spec.title;
...
class DocumentBuilder {
  ...
  serialize() {
    ...
    const dupes = lodash.uniq(viewIds.filter((viewId, i) => viewIds.includes(viewId, i + 1)));
    if (dupes.length > 0) {
...
//# sourceMappingURL=desk-a4a6c841.js.map
